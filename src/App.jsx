...
function AuthScreen({ onAuthed }) {
  ...
  const FAKE_CARDS = [
    { code: 'ENG1', name: 'Jude Bellingham', team: 'England' },
    { code: 'ARG7', name: 'Lionel Messi', team: 'Argentina' },
    { code: 'FRA3', name: 'Kylian Mbappé', team: 'France' },
    { code: 'BRA2', name: 'Vinicius Jr', team: 'Brazil' },
    { code: 'GER4', name: 'Florian Wirtz', team: 'Germany' },
    { code: 'ESP5', name: 'Pedri', team: 'Spain' },
    { code: 'POR8', name: 'Cristiano Ronaldo', team: 'Portugal' },
    { code: 'NED6', name: 'Virgil van Dijk', team: 'Netherlands' },
    { code: 'FWC1', name: 'World Cup Trophy', team: 'FWC Special' },
    { code: 'USA9', name: 'Christian Pulisic', team: 'USA' },
    { code: 'MOR2', name: 'Achraf Hakimi', team: 'Morocco' },
    { code: 'BEL4', name: 'Kevin De Bruyne', team: 'Belgium' },
    { code: 'ITA3', name: 'Sandro Tonali', team: 'Italy' },
    { code: 'JPN7', name: 'Takefusa Kubo', team: 'Japan' },
    { code: 'SEN1', name: 'Sadio Mané', team: 'Senegal' },
    { code: 'COL5', name: 'Luis Díaz', team: 'Colombia' },
  ];
      ...
      <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px 20px 40px' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', borderBottom: '2px solid #f0f0f0' }}>
              <button
                ...
                style={{
                  ...
                  borderBottom: mode === 'login' ? '2px solid #1AAB8A' : '2px solid transparent',
                  color: mode === 'login' ? '#1AAB8A' : '#999',
                  marginBottom: -2,
                  fontFamily: 'inherit',
                }}
              >Log in</button>
              <button
                ...
                style={{
                  flex: 1, padding: '14px 0', fontSize: 13, fontWeight: 700,
                  background: 'none', border: 'none', cursor: 'pointer',
                  borderBottom: mode === 'signup' ? '2px solid #1AAB8A' : '2px solid transparent',
                  color: mode === 'signup' ? '#1AAB8A' : '#999',
                  marginBottom: -2,
                  fontFamily: 'inherit',
                }}
              >Sign up</button>
            ...
            <div style={{ padding: '24px 24px 28px' }}>
              ...
              <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: '#1AAB8A', color: 'white', fontSize: 14,
                ...
                >
                  ...
                  {mode === 'login' ? 'Log in to my account' : 'Create my account'}
                </button>
              </form>
              ...
              {mode === 'login' && (
                <button
                  ...
                  style={{ width: '100%', textAlign: 'center', fontSize: 12, marginTop: 14, color: '#999', background: 'none', border: 'none', cursor: 'pointer', fontFamily: 'inherit' }}
                >
            ...
            {/* Bottom trust strip */}
            <div style={{ background: '#f8f8f8', borderTop: '1px solid #eee', padding: '10px 24px', display: 'flex', justifyContent: 'center', gap: 20 }}>
              {['980 stickers', 'UK collectors', 'Post by post'].map(t => (
                <span key={t} style={{ fontSize: 11, fontWeight: 600, color: '#999' }}>{t}</span>
              ))}
            </div>
          </div>

          {/* Steps — compact, below form */}
          <div style={{ display: 'flex', gap: 20, marginTop: 28, maxWidth: 360, width: '100%' }}>
            {[
              { n: '1', t: 'List spares' },
              { n: '2', t: 'Add needs' },
              { n: '3', t: 'Get matched' },
              ...
              <div key={s.n} style={{ flex: 1, textAlign: 'center' }}>
                <div style={{ width: 22, height: 22, borderRadius: '50%', background: '#1AAB8A', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 11, fontWeight: 800, color: 'white', margin: '0 auto 4px' }}>{s.n}</div>
                <div style={{ fontSize: 10, fontWeight: 600, color: 'rgba(255,255,255,0.5)', lineHeight: 1.2 }}>{s.t}</div>
              </div>
            ))}
          </div>
...
function DashboardScreen() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
      ...
      {/* ── Album stats strip ────────────────────────────────── */}
      <div style={{ background: '#0B1120', borderRadius: 10, padding: '14px 16px', marginBottom: 16, display: 'flex', alignItems: 'center', gap: 0 }}>
        <div style={{ flex: 1, textAlign: 'center', borderRight: '1px solid rgba(255,255,255,0.1)', paddingRight: 0 }}>
          <div style={{ fontSize: 22, fontWeight: 900, color: '#1AAB8A', lineHeight: 1 }}>{980 - totalNeeds}</div>
          <div style={{ fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,0.4)', marginTop: 3, letterSpacing: '0.05em', textTransform: 'uppercase' }}>Collected</div>
        </div>
        <div style={{ flex: 1, textAlign: 'center', borderRight: '1px solid rgba(255,255,255,0.1)' }}>
          <div style={{ fontSize: 22, fontWeight: 900, color: '#1AAB8A', lineHeight: 1 }}>{totalSpares}</div>
          <div style={{ fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,0.4)', marginTop: 3, letterSpacing: '0.05em', textTransform: 'uppercase' }}>Spares</div>
        </div>
        <div style={{ flex: 1, textAlign: 'center', borderRight: '1px solid rgba(255,255,255,0.1)' }}>
          <div style={{ fontSize: 22, fontWeight: 900, color: '#1AAB8A', lineHeight: 1 }}>{totalNeeds}</div>
          <div style={{ fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,0.4)', marginTop: 3, letterSpacing: '0.05em', textTransform: 'uppercase' }}>Needed</div>
        </div>
        <div style={{ flex: 1, textAlign: 'center' }}>
          <div style={{ fontSize: 22, fontWeight: 900, color: '#1AAB8A', lineHeight: 1 }}>{completionPct}%</div>
          <div style={{ fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,0.4)', marginTop: 3, letterSpacing: '0.05em', textTransform: 'uppercase' }}>Done</div>
        </div>
      </div>
      ...
      <div style={{ marginBottom: 20 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
          <span style={{ fontSize: 12, fontWeight: 700, color: 'var(--text-primary)', letterSpacing: '-0.1px' }}>Album progress</span>
          <span style={{ fontSize: 11, color: 'var(--text-muted)', fontWeight: 600 }}>{980 - totalNeeds} of 980</span>
        </div>
        <div style={{ background: '#e8e8e8', borderRadius: 3, height: 6, overflow: 'hidden' }}>
          <div style={{ background: '#1AAB8A', height: '100%', width: `${completionPct}%`, borderRadius: 3, transition: 'width 0.5s ease' }} />
        </div>
      </div>
      ...
      <div style={{ marginBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: duplicatesOpen ? 12 : 8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <button onClick={() => setDuplicatesOpen(o => !o)} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, lineHeight: 1, color: 'var(--text-muted)', fontSize: 13 }}>
              {duplicatesOpen ? '▾' : '▸'}
            </button>
            <h2 style={{ fontSize: 16, fontWeight: 800, color: 'var(--text-primary)', margin: 0, letterSpacing: '-0.2px' }}>Your spares</h2>
            <span style={{ fontSize: 11, fontWeight: 700, background: '#1AAB8A', color: 'white', borderRadius: 4, padding: '2px 6px' }}>{duplicates.length}</span>
          </div>
          <Btn variant="navy" size="sm" onClick={() => setPicker('duplicate')}><Plus size={14} /> Add spare</Btn>
        </div>
        {duplicatesOpen && (
          duplicates.length === 0
      ...
      <div>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: needsOpen ? 12 : 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <button onClick={() => setNeedsOpen(o => !o)} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, lineHeight: 1, color: 'var(--text-muted)', fontSize: 13 }}>
              {needsOpen ? '▾' : '▸'}
            </button>
            <h2 style={{ fontSize: 16, fontWeight: 800, color: 'var(--text-primary)', margin: 0, letterSpacing: '-0.2px' }}>Your needs</h2>
            <span style={{ fontSize: 11, fontWeight: 700, background: '#0B1120', color: 'white', borderRadius: 4, padding: '2px 6px' }}>{needs.length}</span>
          </div>
          <Btn variant="outline" size="sm" onClick={() => setPicker('need')}><Plus size={14} /> Add need</Btn>
        </div>
        {needsOpen && (
          needs.length === 0
  ...
  return (
    ...
    <AuthContext.Provider value={{ token, user }}>
      ...
      <div style={{ minHeight: '100vh', width: '100%', background: 'var(--bg)', fontFamily: "'Nunito', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
        ...
        <main style={{ maxWidth: 640, margin: '0 auto', padding: '16px 14px 90px' }}>
