...
function AuthScreen({ onAuthed }) {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#0B1120' }}>
      ...
      {/* Hero section */}
      <div style={{ padding: '36px 24px 28px', flex: '0 0 auto', maxWidth: 480, margin: '0 auto', width: '100%', boxSizing: 'border-box' }}>
        <h1 style={{ fontSize: 30, fontWeight: 800, color: 'white', margin: '0 0 14px', lineHeight: 1.2, letterSpacing: '-0.5px' }}>
