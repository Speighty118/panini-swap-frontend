...
function AuthScreen({ onAuthed }) {
  ...
  return (
    <div style={{ minHeight: '100vh', width: '100%', display: 'flex', flexDirection: 'column', background: '#0B1120' }}>
      ...
      <div style={{ padding: '36px 24px 28px', flex: '0 0 auto', maxWidth: 480, margin: '0 auto', width: '100%', boxSizing: 'border-box', textAlign: 'center' }}>
        ...
        {/* Steps */}
        <div style={{ marginTop: 32, display: 'flex', flexDirection: 'column', gap: 14, maxWidth: 300, margin: '32px auto 0', textAlign: 'left' }}>
          {[
            { n: '1', title: 'List your spares', desc: 'Add stickers you have more than one of' },
            { n: '2', title: 'Add your needs', desc: 'Tell us which stickers you are missing' },
            { n: '3', title: 'Get matched', desc: 'We find your perfect swap partner' },
            { n: '4', title: 'Swap by post', desc: 'Post stickers to each other and enjoy!' },
          ].map(step => (
            <div key={step.n} style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
              <div style={{ width: 28, height: 28, borderRadius: '50%', background: '#1AAB8A', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13, fontWeight: 800, color: 'white', flexShrink: 0, marginTop: 1 }}>{step.n}</div>
              <div>
                <div style={{ fontSize: 14, fontWeight: 700, color: 'white', marginBottom: 2 }}>{step.title}</div>
      ...
      {/* Form card */}
      <div style={{ flex: 1, padding: '0 20px 40px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <div className="auth-card" style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: 24 }}>
            <img src="data:image/png;base64," alt="Got One Spare?" style={{ width: 64, height: 64, objectFit: 'contain', display: 'block', margin: '0 auto 10px' }} />
          ...
          <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <button
              type="submit"
              disabled={loading}
              style={{ width: '100%', padding: '13px', borderRadius: 12, background: '#1AAB8A', color: 'white', fontSize: 15, fontWeight: 700, border: 'none', cursor: loading ? 'not-allowed' : 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 4 }}
            >
          ...
          >
            ...
            <span style={{ color: '#1AAB8A', fontWeight: 700 }}>{mode === 'login' ? 'Sign up' : 'Log in'}</span>
          </button>
